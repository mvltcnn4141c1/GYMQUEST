...
export default function PartyScreen() {
  ...
  const partyChampionBannerActive = Boolean(party?.championBannerUntil && new Date(String(party.championBannerUntil)) > new Date());
        ...
        {!party ? (
          ...
          <>
            <View style={styles.partyCard}>
              {partyChampionBannerActive ? (
                <View style={styles.partyChampionBanner}>
                  <MaterialCommunityIcons name="flag-checkered" size={13} color={COLORS.gold} />
                  <Text style={styles.partyChampionBannerText}>KLAN SAMPiYON BANNER AKTiF</Text>
                </View>
              ) : null}
...
const styles = StyleSheet.create({
  ...
  partyChampionBannerText: { fontFamily: 'Inter_700Bold', fontSize: 10, color: COLORS.gold, letterSpacing: 0.8 },
  partyHeader: { gap: 6 },
